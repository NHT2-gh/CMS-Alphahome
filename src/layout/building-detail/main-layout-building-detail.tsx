  ...
  return (
    <section className="space-y-4 overflow-visible">
      <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-800">
        ...
        <Link
          href={APP_ROUTES.ADMIN.BUILDINGS.ID.SETTINGS(building?.code || "")}
        >
          <button className="size-10 p-2">
            <Settings className="size-6 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200" />{" "}
          </button>
        </Link>
      </div>
