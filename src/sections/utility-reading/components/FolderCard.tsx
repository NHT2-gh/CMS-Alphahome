...
const FolderCard: React.FC<FolderCardProps> = ({
  ...
  return (
    <div className="rounded-2xl border border-gray-100 bg-gray-50 px-6 py-6 dark:border-gray-800 dark:bg-white/3 xl:py-[27px]">
      <div className="flex justify-between mb-6">
        ...
        <div className="relative">
          ...
          >
            <DropdownItem
              onItemClick={() => handleViewMore(id)}
              className="flex w-full font-normal text-left text-gray-500 rounded-lg hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
            >
              Xem chi tiết
            </DropdownItem>
            <DropdownItem
              onItemClick={() => handleDelete(id)}
              className="flex w-full font-normal text-left text-gray-500 rounded-lg hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
            >
              Xoá
            </DropdownItem>
      ...
      <span className="block float-end text-base text-gray-500 dark:text-gray-400">
        {waterCount} m³ / {electricityCount} kWh
      </span>
    </div>
  );
};
