...
export default function BillMetrics() {
  ...
  // const { data: bills } = useAllBills({ buildingId: building?.id || "" });
  ...
  return (
    ...
    <div className="mb-6 flex items-center justify-between">
      ...
      <ModalCreateBill />
      {/* </div> */}
      {/* <div className="md:flex w-full rounded-xl border border-gray-200 lg:divide-x lg:divide-y-0 dark:divide-gray-800 dark:border-gray-800">
