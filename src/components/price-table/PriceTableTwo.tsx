...
export default function PriceTableTwo() {
  return (
    <div className="grid gap-5 gird-cols-1 sm:grid-cols-2 xl:grid-cols-3 xl:gap-6">
      {/* <!-- Pricing item --> */}
      <div className="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/3 xl:p-8">
      ...
      {/* <!-- Pricing item --> */}
      <div className="rounded-2xl border-2 border-brand-500 bg-white p-6 dark:border-brand-500 dark:bg-white/3 xl:p-8">
        <div className="flex items-start justify-between -mb-4">
          <span className="block font-semibold text-gray-800 text-theme-xl dark:text-white/90">
            Professional
          </span>
