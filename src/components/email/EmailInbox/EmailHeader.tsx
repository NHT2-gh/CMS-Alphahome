      ...
      <div className="flex items-center w-full gap-2">
        ...
        <div className="relative inline-block">
          <button
            ...
            className="flex items-center w-10 dropdown-toggle text-gray-500 justify-center  h-10 transition-colors border border-gray-200 rounded-lg max-w-10 dark:text-gray-400 hover:bg-gray-100 dark:border-white/5 dark:hover:bg-gray-800"
          >
