  ...
  return (
    <div className="flex flex-col justify-between border-b border-gray-200 dark:border-gray-800 sm:flex-row">
      <div className="flex items-center justify-between w-full gap-3 px-4 py-4 sm:justify-normal">
        <button
          onClick={goBack}
          className="flex h-10 w-full max-w-10 items-center justify-center rounded-lg border border-gray-200 bg-white text-gray-700 hover:bg-gray-100 hover:text-gray-800 dark:border-gray-800 dark:bg-white/3 transition dark:text-gray-400 dark:hover:bg-white/[0.07] dark:hover:text-gray-200"
        >
          <svg
            width="16"
            height="16"
        ...
        <div className="flex items-center gap-3">
          <div className="flex">
            <button className="flex h-10 w-10 items-center justify-center text-gray-500 ring-1 ring-inset ring-gray-200 first:rounded-l-lg last:rounded-r-lg hover:bg-gray-100 transition hover:text-error-500 dark:bg-white/3 dark:text-gray-400 dark:ring-gray-700 dark:hover:bg-white/5 dark:hover:text-error-500">
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
            ...
            <button className="-ml-px flex h-10 w-10 items-center justify-center text-gray-500 ring-1 ring-inset ring-gray-200 first:rounded-l-lg last:rounded-r-lg hover:bg-gray-100 transition hover:text-gray-700 dark:bg-white/3 dark:text-gray-400 dark:ring-gray-700 dark:hover:bg-white/5 dark:hover:text-white">
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
          ...
          <button className="flex h-10 transition w-10 items-center justify-center rounded-lg border border-gray-200 bg-white text-gray-500 hover:bg-gray-50 hover:text-gray-700 dark:border-gray-800 dark:bg-white/3 dark:text-gray-400 dark:hover:bg-white/3 dark:hover:text-gray-200">
            <svg
      ...
      <div className="flex items-center justify-between w-full gap-4 px-4 py-3 border-t border-gray-200 dark:border-gray-800 sm:justify-end sm:border-t-0 sm:py-5">
        ...
        <div className="flex items-center justify-end gap-2">
          <button className="flex h-8 w-8 items-center justify-center rounded-lg border border-gray-200 bg-white text-gray-500 hover:bg-gray-50 dark:border-gray-800 dark:bg-white/3 dark:hover:text-gray-200 dark:text-gray-400 dark:hover:bg-white/[0.07] transition">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
