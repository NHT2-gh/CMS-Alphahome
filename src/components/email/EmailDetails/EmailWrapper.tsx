...
export default function EmailWrapper() {
  return (
    <div className="flex flex-col justify-between overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/3 xl:h-full">
      <EmailDetailsHeader />
        ...
        <div className=" p-5  xl:p-6">
          ...
          <div className="p-3 rounded-xl bg-gray-50 dark:bg-gray-900 sm:p-4">
            ...
            <div className="flex flex-col items-center gap-3 sm:flex-row">
              <div className="relative hover:border-gray-300 dark:hover:border-white/5 flex w-full cursor-pointer items-center gap-3 rounded-xl border border-gray-200 bg-white py-2.5 pl-3 pr-5 dark:border-gray-800 dark:bg-white/5 sm:w-auto">
