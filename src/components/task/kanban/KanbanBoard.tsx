...
const KanbanBoard: React.FC = () => {
  ...
  return (
    <DndProvider backend={HTML5Backend}>
      <div className="grid grid-cols-1 border-t border-gray-200 divide-x divide-gray-200 dark:divide-white/5 mt-7 dark:border-white/5 sm:mt-0 sm:grid-cols-2 xl:grid-cols-3">
        <Column
          title="To Do"
