    ...
    <div className="rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/3">
      <div className="px-6">
        <div className="flex flex-col justify-between gap-5 py-4 sm:flex-row sm:items-center">
          ...
          <div>
            <button
              type="button"
              className="shadow-theme-xs flex w-full justify-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/3 dark:hover:text-gray-200"
            >
              <svg
      ...
      <div>
                ...
                <tr key={invoice.id}>
                  ...
                  <td className="px-6 py-3">
                    <div className="flex justify-end gap-2">
                      <button className="shadow-theme-xs inline-flex h-9 w-9 items-center justify-center rounded-lg border border-gray-300 text-gray-500 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-white/3 dark:hover:text-gray-200">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="21"
                          height="20"
        ...
        <div className="rounded-b-xl border-t border-gray-200 px-6 py-4 dark:border-gray-800">
          ...
          <div className="flex items-center justify-between gap-8 bg-gray-50 dark:bg-white/3 p-4 rounded-lg sm:bg-transparent dark:sm:bg-transparent sm:p-0">
            <button
              ...
              className={`shadow-theme-xs flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-2 py-2 text-sm font-medium text-gray-700 sm:px-3.5 sm:py-2.5 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 ${
                currentPage === 1
                  ...
                  : "hover:bg-gray-50 hover:text-gray-800 dark:hover:bg-white/3 dark:hover:text-gray-200"
              }`}
            >
              <svg
