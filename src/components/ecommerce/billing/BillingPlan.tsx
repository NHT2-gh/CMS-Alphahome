export default function BillingPlan() {
  return (
    <div className="rounded-2xl border border-gray-200 bg-white xl:w-4/6 dark:border-gray-800 dark:bg-white/3">
      ...
      <div className="grid grid-cols-1 gap-6 border-t border-gray-200 p-4 sm:p-6 lg:grid-cols-1 xl:grid-cols-2 dark:border-gray-800">
        ...
        <div>
          ...
          <div className="mt-24 flex w-full flex-col items-center justify-between gap-3 sm:flex-row">
            <button
              type="button"
              className="shadow-theme-xs -mx-px flex w-full justify-center rounded-lg border border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/3 dark:hover:text-gray-200"
            >
              Cancel Subscription
            </button>
            <button
