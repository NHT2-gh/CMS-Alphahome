...
export default function BillingInfo() {
  ...
  return (
    <>
      <div className="rounded-2xl border border-gray-200 bg-white xl:w-2/6 dark:border-gray-800 dark:bg-white/3">
        ...
        <div>
          ...
          <div className="mt-8 flex items-center justify-end gap-3">
            <button
              onClick={closeModal}
              type="button"
              className="shadow-theme-xs flex justify-center rounded-lg border border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/3 dark:hover:text-gray-200"
            >
              Close
            </button>
            <button
