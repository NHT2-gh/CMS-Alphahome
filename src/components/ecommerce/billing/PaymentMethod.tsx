          ...
          <div className="flex gap-5 rounded-xl border border-gray-200 p-3 pr-5 dark:border-gray-800">
            ...
            <div>
              ...
              <div className="mt-4 flex flex-wrap gap-3">
                <button className="shadow-theme-xs inline-flex h-6 items-center justify-center rounded-md border border-gray-300 px-3 py-1 text-xs font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-white/3 dark:hover:text-gray-200">
                  Edit
                </button>
                <button className="shadow-theme-xs inline-flex h-6 items-center justify-center rounded-md border border-gray-300 px-3 py-1 text-xs font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-white/3 dark:hover:text-gray-200">
                  Delete
