        ...
        <div className="mt-4">
          ...
          {selected === "daily" && (
            <div className="space-y-4">
              <div className="grid grid-cols-2 justify-between gap-10 divide-x divide-gray-100 rounded-xl border border-gray-100 bg-white py-4 dark:divide-gray-800 dark:border-gray-800 dark:bg-gray-800/3">
                <div className="px-5">
