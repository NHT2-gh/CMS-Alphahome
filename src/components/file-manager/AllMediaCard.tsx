...
const fileData = [
  {
    ...
    iconStyle: "bg-success-500/8 text-success-500",
  },
  {
    icon: <VideoIcon />,
    title: "Videos",
    ...
    fileCount: 245,
    storageUsed: "26.40 GB",
    iconStyle: "bg-theme-pink-500/8 text-theme-pink-500",
  },
  {
    icon: <AudioIcon />,
    title: "Audios",
    ...
    iconStyle: "bg-blue-500/8 text-blue-light-500",
  },
  {
    icon: <GridIcon />,
    title: "Apps",
    ...
    iconStyle: "bg-orange-500/8 text-orange-500",
  },
  {
    icon: <FileIcon />,
    title: "Documents",
    ...
    fileCount: 78,
    storageUsed: "5.40 GB",
    iconStyle: "bg-warning-500/8 text-warning-500",
  },
  {
    icon: <DownloadIcon />,
    title: "Downloads",
    ...
    fileCount: 245,
    storageUsed: "26.40 GB",
    iconStyle: "bg-theme-purple-500/8 text-theme-purple-500",
  },
];
