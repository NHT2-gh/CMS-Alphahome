        ...
        <div className="flex flex-col flex-wrap items-center gap-4 sm:flex-row sm:gap-5">
          <div className="flex flex-col flex-wrap items-center gap-4 sm:flex-row sm:gap-5">
            <div>
              ...
              >
                <div className="relative rounded-t-xl border-b border-gray-200 bg-gray-100 px-5 py-3 dark:border-white/3 dark:bg-[#252D3A]">
            ...
            <div>
              ...
              >
                <div className="rounded-t-xl border-b relative  border-gray-200  bg-gray-200 px-5 py-3 dark:border-white/3 dark:bg-[#252D3A]">
                  <h3 className="text-base font-semibold text-gray-800 dark:text-white/90">
                    Top Popover
                  </h3>
                </div>
