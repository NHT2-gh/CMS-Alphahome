    ...
    <div className="overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/3">
      ...
      <div>
        ...
        <div className="flex items-center flex-col sm:flex-row justify-between border-t border-gray-200 px-5 py-4 dark:border-gray-800">
          ...
          <div className="flex items-center bg-gray-50 dark:bg-white/3 p-4 sm:p-0 sm:bg-transparent rounded-lg dark:sm:bg-transparent w-full sm:w-auto justify-between gap-2 sm:justify-normal">
            <button
              onClick={prevPage}
              disabled={page === 1}
              className="shadow-theme-xs flex items-center gap-2 rounded-lg border border-gray-300 bg-white p-2 text-gray-700 hover:bg-gray-50 hover:text-gray-800 disabled:opacity-50 sm:p-2.5 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/3 dark:hover:text-gray-200"
            >
              <svg
